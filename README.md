...
settings back. The automatic restore path verifies the readable Dock preference
values after writing them; if verification fails, the Restore section keeps the
manual Terminal commands visible.
